...
3. Da [biste saznali kako da se upišu macOS uređaja u Microsoft Intune](https://docs.microsoft.com/en-us/intune/macos-enroll).
    
[Pogledajte Vodič za krajnjeg korisnika da se prijavi macOS uređaj u Microsoft Intune](https://docs.microsoft.com/en-us/intune-user-help/enroll-your-device-in-intune-macos-cp)
