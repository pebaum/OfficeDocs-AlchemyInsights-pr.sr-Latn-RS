...
Podaci o NS ili CNAME (DNS) postavkama nisu ispravno podešeni. Za detaljne instrukcije možete da uputite na [Kreiranje DNS zapisa kod bilo kog dobavljača DNS hostinga](https://docs.microsoft.com/office365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider) . 
