...
ms.locfileid: "36507177"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="edb03-102">Pristup stranici domeni</span><span class="sxs-lookup"><span data-stu-id="edb03-102">Access the Domains Page</span></span>

<span data-ttu-id="edb03-103">Da biste pristupili stranici domeni, samo kliknite na ovu ikonu ispod:</span><span class="sxs-lookup"><span data-stu-id="edb03-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="edb03-104">Onda možete dodati, izmenite ili uklonite vašeg domena.</span><span class="sxs-lookup"><span data-stu-id="edb03-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="edb03-105">Za više informacija, pogledajte u [domeni FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="edb03-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
