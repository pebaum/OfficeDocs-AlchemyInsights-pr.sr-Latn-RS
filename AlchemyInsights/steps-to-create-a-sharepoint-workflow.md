---
title: Korake da biste kreirali tok posla SharePoint
ms.author: efrene
author: efrene
ms.date: 8/6/2019
ms.audience: ITPro
...
- Ako niste u mogućnosti da biste dodali SharePoint 2010 odobravanja tok, vidim [nije moguće dodati podrazumevani tok posla za odobravanje 2010](https://docs.microsoft.com/alchemyinsights/can-t-add-default-2010-approval-workflow).
- Kako da kreiraju tokove posla:
    - [Tok posla 2013 iz SharePoint Designer](https://docs.microsoft.com/sharepoint/dev/general-development/creating-a-workflow-by-using-sharepoint-designer-and-the-sharepoint-wo)
    - [Tok posla 2010 iz SharePoint Designer](https://support.office.com/article/introduction-to-designing-and-customizing-workflows-32c9c0bf-5e20-4f74-8b9c-d3ea79f2962b)
    - [Uvod u SharePoint toka posla](https://support.office.com/article/introduction-to-sharepoint-workflow-07982276-54e8-4e17-8699-5056eff4d9e3)
