...
Potrebna vam je pomoć da uključite i podesite funkciju za pristup gosta u Microsoft timovima?  

Najpre se uverite da ste pratili sve korake u [listi za proveru pristupa gosta](https://docs.microsoft.com/en-us/microsoftteams/guest-access-checklist). Kada svi ovi koraci budu dovršeni, potrebno je da [sačekate do 24 časa](https://docs.microsoft.com/en-us/microsoftteams/manage-guests#guest-access-latencies) da bi postavke stupile na snagu.
