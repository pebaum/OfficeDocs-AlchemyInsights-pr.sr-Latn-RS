...
Moderna lokacijama (komunikacije, grupa povezana, ili druge lokacije) koje postoje u novi admin centar za pregled, potražite u odeljku [prikaz i vraćanja izbrisane lokacije u centru za admin novu SharePoint](https://docs.microsoft.com/en-us/sharepoint/restore-deleted-site-collection).
